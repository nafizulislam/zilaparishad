@extends('layouts.layouts') @push('css') <style type="text/css">
    ...
    <div class="container-fluid">
      <div class="row">
        <!-- TAB -->
        <div class="col-xl-12">
          <h2 class="title">আয় ব্যায়ের তালিকা</h2>
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li class="nav-item" role="presentation">
              <a href="" class="nav-link active ">সকল আয় সমূহ </a>
          ...
          <div class="d-flex justify-content-between">
            <h3>
              <i class="fa fa-address-book" aria-hidden="true" style="margin-right:10px"></i>সকল আয় সমূহের তালিকা
            </h3>
            <form>
              <div class="row">
                <div class="col">
