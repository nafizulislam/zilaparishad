      ...
      <div class="row">
        ...
        <div class="col-xl-12">
          ...
          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a href="{{ route('income.index') }}" class="nav-link active">আয়ের উৎস</a>
            ...
            <li class="nav-item" role="presentation">
                <a href="{{ route('cost.index') }}" class="nav-link">ব্যায়ের উৎস</a>
                <!-- <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">ভাড়াটিয়া, ইজারাদার</button> -->
              </li>
          </ul>
          {{-- new add --}}
                        ...
                        <div class="modal-content">
                          <div class="modal-header">
                            <h3 class="modal-title text-center">
                              <i class="fa fa-address-book" aria-hidden="true" style="margin-right:10px"></i> নতুন আয়ের উৎস তালিকা ভুক্ত করুন
                            </h3>
                              ...
                              <form method="POST" action="{{route('income.store')}}" enctype="multipart/form-data">
                                @csrf <div class="row">
                                  <div class="col-md-10 offset-md-1">
                                    ...
                                    <input type="text" name="income_source" class="form-control" required>
                                  </div>
                                  <br>
                                  <br>
                      ...
                      <table class="table display mb-4 dataTablesCard order-table card-table text-black application" id="example">
                        ...
                        <tbody>
                            ...
                            <td class="wspace-no">
                              <span class="fs-16">
                                <ul class="d-inline-block">
                                  <a class="infoBtn" type="button" data-id="{{ $row->id }}" data-bs-toggle="modal" data-bs-target="#personalModal">{{$row->income_source}}</a>
                                </ul>
                              </span>
                            </td>
                            ...
                            <td class="d-flex justify-content-center">
                                ...
                                <form action="{{ route('income_source_delete',$row->id) }}" id="delete" method="POST">
                                    @csrf
                                    @method('DELETE')
                                ...
                                {{-- <a href="{{ route('income_source_delete',$row->id) }}" id="delete" type="submit" class="btn btn-danger" ><i class="fas fa-eraser"></i></a> --}}
                              </td>
                          </tr>
                          @endforeach
                        </tbody>
                                  ...
                                  <div class="col-xl-12" style="    background: #fff;">
                                    <div class="tab-content custom-content">
                                      <div id="v-pills-home" class="tab-pane fade active show">
                                        <div class="basic-form">
                                          <h3 class="mb-5">
                                            <i class="fa fa-address-book " style="margin-right: 7px;"></i>  আয়ের উৎসের তথ্য সংশোধন
                                          </h3>
                                          <form id="insert_form" method="" action="" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" name="income_update_id" id="income_source_id">
                                              <div class="col-md-12">
                                                <label class="form-label">আয়ের উৎসের নাম</label>
                                                <input type="text" name="income_source"  id="edit_income_source" placeholder="আয়ের উৎসের নাম পরিবর্তন করুন " class="form-control" required>
                                              </div>
                                              <div class="col-md-10">
                                                  <br>
  ...
  <script>
    $(document).ready(function(){
      $(".editPicModal").click(function(){
        ...
        // alert(id)
        $.ajax({
          url: '/api/income_source_details/' + id,
          type: 'GET',
          data: {
            "id": id
          },
          ...
          document.getElementById("income_source_id").value = data.data.id;
          document.getElementById("edit_income_source").value = data.data.income_source;
  ...
  <script>
      $("#insert_form").submit(function(e) {
        ...
        //   alert("hi")
          ...
          var form = $(this);
          var id = $("#income_source_id").val();
          var income_source = $("#edit_income_source").val();

        //   alert(income_source)

          $.ajax({
              type: "POST",
              url: "/api/update_income_source_by_id/"+id,
              // data: form.serialize(),
              data : {
