        ...
        <div class="container-fluid h-100">
            <div class="row  align-items-end">
                ...
                <div class="col-md-4 no-gutters">
                    <div class="authincation-content" style="height: 625px;width: 100%;background: #f4fdf4;">
                                ...
                                <div class="auth-form">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="password" class="form-control @error('password') is-invalid @enderror"  placeholder="আপনার পাসওয়ার্ড দেন" name="password" required autocomplete="current-password">
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
