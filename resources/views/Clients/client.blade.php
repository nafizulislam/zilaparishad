...
@section('title') পিআইসি হোল্ডার @endsection
@section('content')
            ...
            <div class="row">
              <div class="col-xl-12">
                <div class="d-flex btn-margin" style="    float: right;">
                  ...
                  <button style="width: 150px; margin-left:20px;height: 40px;" type="button"
                    class="btn btn-success btn-background" data-bs-toggle="modal" data-bs-target="#basicModal">নতুন
                    সংযোগ</button>
                            ...
                            <form method="POST" action="{{route('client.store')}}" enctype="multipart/form-data"> @csrf
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                  ...
                                  <input type="text" name="phone" class="form-control" value="{{ old('phone') }}"
                                    required placeholder="Please Enter Phone Number">
                                  @error('phone')
                                  <span class="text-danger">{{ $message }}</span>
                                  @enderror
                                </div>
                              ...
                              <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                  ...
                                  <input type="text" name="authorise_person_nid"
                                    value="{{ old('authorise_person_nid') }}" class="form-control" required
                                    placeholder="Please Enter NID Number">
                                ...
                                <div class="mb-3 col-md-4">
                                  ...
                                  <input type="text" name="bank_name" value="{{ old('bank_name') }}"
                                    class="form-control" required placeholder="Please Enter Bank Address">
                                  @error('bank_name')
                                  <span class="text-danger">{{ $message }}</span>
                                  @enderror
                                </div>
              ...
              <div class="col-xl-12 mt-3">
                <div class="list">
                  <div class="table-responsive">
                    <table class="table display mb-4 dataTablesCard order-table card-table text-black application"
                      id="example">
                        ...
                        <tr>
                          <td class="wspace-no">
                            <span class="fs-16">
                              ...
                              <ul class="d-inline-block">
                                <a class="infoBtn" type="button" data-id="{{ $pci_holder->id }}" data-bs-toggle="modal"
                                  data-bs-target="#personalModal">{{$pci_holder->name}}</a>
                          ...
                          <td class="d-flex">
                            <span class="btn btn-outline light  border-light btn-sm " style="margin-right:5px">
                              <a class="editPicModal" type="button" data-bs-target="#editModal"
                                data-id="{{ $pci_holder->id }}" data-bs-toggle="modal"><i class="fas fa-pen"></i></a>
                            </span>
                            <form action="{{ route('client.delete',$pci_holder->id) }}" id="delete" method="POST">
                              @csrf @method('DELETE')
                              ...
                              <div class="col-xl-12" style="    background: #fff;">
                                <div class="tab-content custom-content">
                                  <div id="v-pills-home" class="tab-pane fade active show">
                                    <div class="basic-form">
                                      <h3 class="mb-5">
                                        <i class="fa fa-address-book " style="margin-right: 7px;"></i> পিআইসি হোল্ডারের
                                        তথ্য সংশোধন
                                      </h3>
                                      <form id="insert_form" method="post" action="" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="mb-3 col-md-4">
                                            ...
                                            <input type="file" id="new_pic_photo" name="photo"
                                          ...
                                          <div class="mb-3 col-md-4">
                                            <label class="form-label">সভাপতির নাম</label>
                                            <input type="text" id="edit_authorise_person" name="authorise_person"
                                              class="form-control" required>
                                            @error('authorise_person')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                          ...
                                          <div class="mb-3 col-md-4">
                                            <label class="form-label">সভাপতির মোবাইল নম্বর</label>
                                            <input type="text" id="edit_authorise_person_mobile"
                                              name="authorise_person_mobile" class="form-control" required>
                                            @error('authorise_person_mobile')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                          </div>
                                          <div class="mb-3 col-md-4">
                                            <label class="form-label">সভাপতির এনআইডি নাম্বার</label>
                                            <input type="text" id="edit_authorise_person_nid"
                                              name="authorise_person_nid" class="form-control" required>
                                            @error('authorise_person_nid')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                          </div>
                                          ...
                                          <input type="submit" value="আপডেট করুন"
                                            class="btn btn-success mb-3 col-md-6 offset-md-3">
          ...
          <div class="row">
            <div class="col-xl-3">
              <div class="nav custom-tab flex-column nav-pills mb-3">
                ...
                <a href="#v-pills-home1" data-bs-toggle="pill" class="nav-link active show">
                  <i class="fas fa-folder-minus" style="margin-right: 7px;"></i>বিস্তারিত তথ্য </a>
                <a href="#v-pills-profile1" data-bs-toggle="pill" class="nav-link">
            ...
            <div class="col-xl-9" style="    background: #fff;">
              <div class="tab-content custom-content">
                <div id="v-pills-home1" class="tab-pane active show fade">
                  <div class="basic-form">
                    <h3 class="mb-5">
                    ...
                    <form method="POST" action="{{route('client.store')}}" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                          <label class="form-label">স্থায়ী ঠিকানা</label>
                          <input type="text" name="permanent_address" readonly id="permanent_address"
                            class="form-control">
                        </div>
                      </div>
                      <div class="row">
                        <div class="mb-3 col-md-4">
                          <label class="form-label">সভাপতির নাম</label>
                          <input type="text" id="authorise_person" readonly name="authorise_person"
                            class="form-control">
                        </div>
                        <div class="mb-3 col-md-4">
                          <label class="form-label">সভাপতির মোবাইল নম্বর</label>
                          <input type="text" id="authorise_person_mobile" readonly name="authorise_person_mobile"
                            class="form-control">
                        </div>
                        <div class="mb-3 col-md-4">
                          <label class="form-label">সভাপতির এনআইডি নাম্বার</label>
                          <input type="text" id="authorise_person_nid" readonly name="authorise_person_nid"
                            class="form-control">
                        </div>
                        <div class="mb-3 col-md-4">
                          <label>ব্যাংকের নাম</label>
                    ...
                    <form method="POST" action="{{route('project.store')}}" enctype="multipart/form-data">
                       ...
                       <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                          ...
                          <input type="text" name="collective_number" readonly id="collective_number"
                            class="form-control">
                        </div>
                        <div class="mb-3 col-md-4">
                ...
                <div id="v-pills-messages" class="tab-pane fade">
                  {{-- <p>Fugiat id quis dolor culpa eiusmod anim velit excepteur proident dolor aute qui magna. Ad
                    proident laboris ullamco esse anim Lorem Lorem veniam quis Lorem irure occaecat velit nostrud magna
                    nulla. Velit et et proident Lorem do ea tempor officia dolor. Reprehenderit Lorem aliquip labore est
                    magna commodo est ea veniam consectetur.</p> --}}
                </div>
                <div id="v-pills-settings" class="tab-pane fade">
                  {{-- <p>Eu dolore ea ullamco dolore Lorem id cupidatat excepteur reprehenderit consectetur elit id
                    dolor proident in cupidatat officia. Voluptate excepteur commodo labore nisi cillum duis aliqua do.
                    Aliqua amet qui mollit consectetur nulla mollit velit aliqua veniam nisi id do Lorem deserunt amet.
...
<script>
  $(document).ready(function() {
    $(".infoBtn").click(function() {
      const x_id = $(this).attr('data-id');
      console.log(x_id)
    //   alert(id);
      $.ajax({
        url: 'pic_details/'+x_id,
        type: 'GET',
        // data: {
        //   "id": id
        // },
