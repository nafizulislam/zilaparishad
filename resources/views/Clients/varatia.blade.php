...
<div class="content-body">
				...
				<div class="row">
					...
					<div class="col-xl-12">
                        ...
                        <li class="nav-item" role="presentation">
						  	...
						  	<li class="nav-item" role="presentation">
							  <a href="{{ route('varatia.index') }}" class="nav-link active">ভাড়াটিয়া, ইজারাদার</a>
        ...
        <div class="d-flex justify-content-between">
            ...
            <h3>
                ...
                ভাড়াটিয়া, ইজারাদারগণের তালিকা
            </h3>
            <form>
                  <div class="row">
                        <div class="col">
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title"><i class="fa fa-address-book" aria-hidden="true" style="margin-right:10px"></i>নতুন ভাড়াটিয়া/ইজারাদার তালিকা ভুক্ত করুন</h3>
                            <button type="button" class="btn-close" data-bs-dismiss="modal">
                            </button>
                        </div>
                        <div class="modal-body">
                            <div class="basic-form">
                                <form method="POST" action="{{route('varatia.store')}}" enctype="multipart/form-data">
                                @csrf
                                    <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <form action="{{ route('varatia.delete',$row->id) }}" id="delete" method="POST">
            ...
            <div class="col-xl-9" style="    background: #fff;">
              <div class="tab-content custom-content">
                <div id="v-pills-home" class="tab-pane fade active show">
                  <div class="basic-form">
                    <h3 class="mb-5">
                      <i class="fa fa-address-book " style="margin-right: 7px;"></i>ভাড়াটিয়ার বিস্তারিত তথ্য
                    </h3>
...
<script>
    $.ajaxSetup({
        ...
        $.ajax({
            type:'POST',
            url: `/api/update_varatia_by_id/`+id,
            data: formData,
            contentType: false,
            processData: false,
            success: (response) => {
